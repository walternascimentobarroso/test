...
<a href="/rule/create" class="btn btn-outline-success">Add</a>
<hr />
<table class="table table-dark table-hover">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td style="text-decoration: {!! $style !!}">{{ $list->rule}}</td>
            <td style="text-decoration: {!! $style !!}">{{ $list->description}}</td>
            <td style="text-decoration: {!! $style !!}">{{ $list->active ? 'Yes' : 'No'}}</td>
            <td>
                <a href="/rule/{{ $list->id}}" class="btn btn-outline-info">See</a>
                <a href="/rule/{{ $list->id}}/edit" class="btn btn-outline-warning">Edit</a>
                <!-- <form action="/rule/{{ $list->id}}" method="POST" style="display: inline;">
                    @csrf
...
<script>
    ...
    function changeRoute({
        ...
        formRemove.action = `/rule/${dataset.id}`;
